...
function setup_progress_bar_animation()
{
    ...
    // setTimeout(function on(){ document.getElementById("overlay").style.display = "block"; }, 0); 
    ...
    // setTimeout(function off(){document.getElementById("overlay").style.display = "none"; }, 8000);
